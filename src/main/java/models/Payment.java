...
public class Payment {
    ...
    public Payment(int paymentId, int bookingId, double amount, String method, String paymentStatus, Timestamp paymentDate,
                   String verifiedByDriver, String verificationStatus, double driverEarnings, double companyShare) {
